        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="single-recent-blog-post">
              <div class="thumb">
                <img class="img-fluid" src="{{  asset('/assets/img/gallery/'.$data->foto)}}" alt="">
              </div>
              ...
              <div class="details mt-20">
                ...
                <p class="tag-list-inline"> @foreach ($data->tag as $key)
                <a href="/blog/{{$key->slug}}">#{{ $key->nama }}</a>
                                @endforeach</p>
                                <p class="tag-list-inline"> <a href="{{$data->kategori->slug}}">{{$data->kategori->nama}}</p>
                                <a class="button" href="/blog/{{$data->id}}">Read More <i class="ti-arrow-right"></i></a>
              </div>
            </div>
            @endforeach
            </div>
